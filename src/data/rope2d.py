"""
ROPE 2D index calculation for Qwen-VL models
Based on original: qwenvl/data/rope2d.py
"""
import torch
...
def get_rope_index_3(
    ...
    """Qwen3VL rope index calculation."""
...
def get_rope_index_25(
    ...
    """Qwen2.5VL rope index calculation."""
    image_token_id = 151655
    video_token_id = 151656
    vision_start_token_id = 151652
    mrope_position_deltas = []
...
def get_rope_index_2(
    ...
    """Qwen2VL rope index calculation."""
    image_token_id = 151655
    video_token_id = 151656
    vision_start_token_id = 151652
    mrope_position_deltas = []
